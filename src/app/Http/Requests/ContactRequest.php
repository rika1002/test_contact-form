...
class ContactRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            "front-tel.regex" => "電話番号は半角数字で入力してください",
            "middle-tel.regex" => "電話番号は半角数字で入力してください",
            "back-tel.regex" => "電話番号は半角数字で入力してください",
            "front-tel.max" => "電話番号は5桁までの数字で入力してください",
            "middle-tel.max" => "電話番号は5桁までの数字で入力してください",
            "back-tel.max" => "電話番号は5桁までの数字で入力してください",
